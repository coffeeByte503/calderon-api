...
function _createProduct() {
  _createProduct = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var newProduct, productSaved;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          newProduct = new _Products["default"](req.body);
          _context.next = 3;
...
function _getProducts() {
  _getProducts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var products;
...
function _getProductById() {
  _getProductById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var product;
...
function _updateProductById() {
  _updateProductById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var updatedProduct;
...
function _deleteProductById() {
  _deleteProductById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var deletedProduct;
